...
if(__X86_64)
  ...
  set(SPARSE_SEEK_AVX_SRC src/simd/sparse_seek_avx.cc)
  ...
  add_library(sparse_seek_avx OBJECT ${SPARSE_SEEK_AVX_SRC})
  ...
  target_compile_options(sparse_seek_avx PRIVATE -mavx2)
  ...
  add_library(
    ...
    $<TARGET_OBJECTS:sparse_simd_avx512> $<TARGET_OBJECTS:sparse_seek_avx>
    $<TARGET_OBJECTS:sparse_seek_avx512>)
